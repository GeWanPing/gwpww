#
#  Be sure to run `pod spec lint gwpww.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  # Or just: spec.author    = "gewanping"
  # spec.authors            = { "gewanping" => "307299394@qq.com" }
  # spec.social_media_url   = "https://twitter.com/gewanping"
  ...
  # spec.osx.deployment_target = "10.7"  # spec.watchos.deployment_target = "2.0"
